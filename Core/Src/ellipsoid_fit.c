...
int magneto_calculate(float *buffer, uint32_t samples, FusionVector *hardiron, FusionMatrix *softiron){
	...
	if (nxsrej > 0) {
		...
		for( i = 0; i < nlines; i++)
		{
			...
			if (x2 > nxsrej) {
				ngood--;
				//uart_printf_data("reject #%d, %8.1f %8.1f %8.1f\r\n",i, x,y,z);
			}
		}
	...
	//uart_printf_data("\r\r\nWhere Hcalc = Ainv*(H-B)\r\r\n");

	//uart_printf_data("\r\r\nCode initialization statements...\r\r\n");
	//uart_printf_data("\r\r\n float B[3]\r\r\n {%8.2lf,%8.2lf,%8.2lf};\r\r\n",B[0],B[1],B[2]);
	//uart_printf_data("\r\r\n float Ainv[3][3]\r\r\n  {{%9.5lf,%9.5lf,%9.5lf},\r\r\n",A_1[0],A_1[1],A_1[2]);
	//uart_printf_data("  {%9.5lf,%9.5lf,%9.5lf},\r\r\n",A_1[3],A_1[4],A_1[5]);
	//uart_printf_data("  {%9.5lf,%9.5lf,%9.5lf}};\r\r\n",A_1[6],A_1[7],A_1[8]);
...
//     uart_printf_data("The submatrix B is \r\n"); ... }                                 //
////////////////////////////////////////////////////////////////////////////////
...
//     if (err < 0) uart_printf_data(" Matrix A is singular\r\n");                        //
...
//        if (err < 0) uart_printf_data(" Matrix A is singular\r\n");                     //
//        else uart_printf_data(" The solution is \r\n");                                 //
//           ...                                                              //
//     }                                                                      //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
//        if (err < 0) uart_printf_data(" Matrix A is singular\r\n");                     //
//        else uart_printf_data(" The inverse is \r\n");                                  //
//           ...                                                              //
//     }                                                                      //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
//        uart_printf_data("Not enough memory\r\n"); exit(0);                             //
//     }                                                                      //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
//     if (err < 0) uart_printf_data(" Matrix L is singular\r\n");                        //
//     else {                                                                 //
//        uart_printf_data(" The inverse is \r\n");                                       //
//           ...                                                              //
//     }                                                                      //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
//     if (err < 0) uart_printf_data(" Matrix U is singular\r\n");                        //
//     else {                                                                 //
//        uart_printf_data(" The inverse is \r\n");                                       //
//           ...                                                              //
//     }                                                                      //
